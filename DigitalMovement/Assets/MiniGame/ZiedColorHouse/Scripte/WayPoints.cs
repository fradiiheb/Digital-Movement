...
public class WayPoints : MonoBehaviour
{
    ...
    public List<NextWayPoint> nextwaypoint = new List<NextWayPoint>();
    ...
    public Transform GetNextWaypoint(Transform currentWayPoint,int index)
    {
        ...
        if (currentWayPoint == null )
        {
            ...
            nextwaypoint[index] = transform.GetChild(0).gameObject.GetComponent<NextWayPoint>();
        ...
        if (nextwaypoint[index].dynamic)
        {
            ...
            if (!nextwaypoint[index].swap)
            {
                ...
                nextwaypoint[index] = nextwaypoint[index].nextWaypoint[0].gameObject.GetComponent<NextWayPoint>();
            ...
            else
            {
                ...
                nextwaypoint[index] = nextwaypoint[index].nextWaypoint[1].gameObject.GetComponent<NextWayPoint>();
